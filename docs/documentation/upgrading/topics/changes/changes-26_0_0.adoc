...
Note: This feature required changes in `Keycloak.js`, therefore it is recommended to upgrade to the latest `Keycloak.js` library when upgrading to this {project_name} version.
